...
usage -auto -elapse
set log file lec_Jul10-19:25:17/rtl2final.lec.log -replace
tclmode
...
read library -statetable -liberty -both  \
	...
	/pdk/xfab/XC018_61_3.1.3/synopsys/xc018/MOSST/D_CELLS_MOSST_fast_1_98V_m40C.lib \
...
vpx read design -verilog -revised -lastmod -noelab \
	lec_Jul10-19:25:17/USFFT64_2B_final.v
} else {
